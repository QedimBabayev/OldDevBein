...
class InvoiceOutFormComponent extends Component {
  ...
  onChangeSpendItem = (value, option) => {
  ...
  onFinish = (values) => {
    ...
    console.log("customerid", this.formRef.current.getFieldValue("customerid"));
    ...
    if (!this.state.sendRequest) {
      progress(true);
      this.props.saveDocument("invoiceouts", sendObject);
    }
            ...
            <Row className="top_wrapper_holder">
              <Col xs={24} md={24} xl={6}>
                <div className="first_form_wrapper">
                  <Form.Item
                    label={<Trans word={"InvoiceOut Number"} />}
                    name="name"
                ...
                <div className="second_form_wrapper">
                  ...
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: "Zəhmət olmasa, Xərc maddəsi seçin",
                      },
                    ]}
                  >
                    <Select
                      ...
                      onChange={this.onChangeSpendItem}
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(LoaderHOC(InvoiceOutFormComponent, "datas"));
