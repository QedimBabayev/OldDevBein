...
import buttonsNames
  from '../ButtonsNames/NotDocs/NotDocsDifferent/buttonsNames';
...
import SupplyReturnFormComponent from './SupplyReturnFormComponent';
...
class CreateSupplyReturnForm extends Component {
  ...
  deleteDoc = (id, e) => {
    e.stopPropagation ();
    var grFilter = {};
    this.props.delData ('supplyreturns', grFilter, id);
  };
  ...
  render () {
    if (this.props.state.putdatas.redirectDelete === true) {
      return <Redirect push to="/p=supplyreturns" />;
    }
      ...
      <Menu>
        <Menu.Item key="0">
          <Button
            ...
            disabled={
              this.state.docid === ''
                ? this.state.newDocId === '' ? true : false
                : false
            }
          >
            Sənədi silin
      ...
      <div className="table_holder">
        ...
        <MobileDrawer
          docbuttons={
            <DocButtons
              ...
              from={this.props.fromdoc ? this.props.fromdoc : 'p=supplyreturns'}
              linkedDocs={this.props.state.datas.doc ? true : false}
              doc={this.props.state.datas.doc}
              toDoc="createPaymentOut"
              fromDoc="createSupplyReturn"
        ...
        <Row className="filter_table_wrapper_row doc">
          <Col className="page_name_wrapper" xs={24} md={24} xl={24}>
            <h2 className="custom_top_margin">Təchizatçıya qaytarma</h2>
          </Col>
          ...
          <Col xs={24} md={24} xl={24}>
            <DocTable
              ...
              datasource={
                this.props.id
                  ? this.props.state.datas.doc[0].Positions
...
export default connect (mapStateToProps, mapDispatchToProps) (
  LoaderDocHOC (CreateSupplyReturnForm, 'fetching')
);
